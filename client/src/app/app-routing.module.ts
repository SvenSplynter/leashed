...
import { AdminGuard } from './webshop/core/guards/admin.guard';
import { AuthGuard } from './webshop/core/guards/auth.guard';

const routes: Routes = [
  {path: 'admin', canActivate:[AuthGuard, AdminGuard], loadChildren: () => import('./admin/admin.module').then(mod => mod.AdminModule)},
